...
annotate OrderService.ProductCatalogue with @(
    UI: {
          HeaderInfo: {
        ...
        Identification: [
            { $Type  : 'UI.DataFieldForAction', Action : 'OrderService.addProductToOrder',   Label  : '{i18n>AddToOrder}'   },
...
annotate OrderService.OrderTemplateItem  with @UI : {
